...
heroTitle: "pubmed, from the command line"
heroLead: "Search PubMed biomedical literature One pure-Go binary, no API key, output that pipes into the rest of your tools."

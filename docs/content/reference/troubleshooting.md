...
Most of these come down to network reality or how pubmed serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

pubmed rate-limits like any public site. pubmed already paces
...
Where a surface is gated, pubmed reads a cookie or token you supply
...
`pubmed`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what pubmed actually did
